...
void function(window, document, undefined) {
  ...
  var COLUMN_WIDTH = 212.5;   // cell width: 290, padding: 14 * 2, border: 1 * 2
...
//		return MIN_COLUMN_COUNT
  ...
  var appendCellsDemo = function(num) {
    ...
    var fragment = document.createDocumentFragment();
    var cells = [];
    var images = [0, 286, 243, 270, 243, 290, 285, 252, 275, 285, 285, 228, 281, 242, 339, 236, 257, 286, 259, 267, 237, 253, 227, 290, 290, 225, 269, 264, 272, 226, 265, 287, 269, 225, 285, 290, 314, 241, 219, 274, 274, 285, 226, 279, 243, 266, 279, 600, 276, 285, 282, 243, 287, 226, 290, 285, 243, 241, 266, 240, 290];
    for(var j = 0; j < 10; j++) {
    	console.log(key)
      ...
      cells.push(cell);
      front(cellTemplate, { 'title': 'demo picture ' + key, 'src': key, 'height': "auto", 'width': 182.5 }, cell);
      fragment.appendChild(cell);
    }
